...
def identification_field_factory(label, error_required):
    ...
    attrs_dict = {
    'class': 'required',
    'onmouseover' :  'onusericon()',
    'onmouseout'  :  'offusericon()',
    }
...
class AuthenticationForm(forms.Form):
    ...
    attrs_dict = {
        'class': 'required',
        'onmouseover' :  'onpassicon()',
        'onmouseout'  :  'offpassicon()',
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        # it again here.
        self.fields['remember_me'].label = _(u'Remember me') % {'days': _(userena_settings.USERENA_REMEMBER_ME_DAYS[0])}
